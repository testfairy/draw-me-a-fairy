...
public class TestFairyFeedbackOverlay {
	 ...
	 */
	static public void installOverlay(Context context, String appToken, boolean showImmediately) {
			...
			if (animated) {
				...
				translateAnimation.setAnimationListener(new Animation.AnimationListener() {
					...
					public void onAnimationStart(Animation animation) {
						instance.container.setVisibility(View.VISIBLE);
					}
				...
				instance.container.startAnimation(translateAnimation);
			} else {
				instance.container.setVisibility(View.VISIBLE);
			}
		...
		if (instance != null && instance.container != null) {
			if (animated) {
				...
				translateAnimation.setAnimationListener(new Animation.AnimationListener() {
					...
					@Override
					public void onAnimationEnd(Animation animation) {
						instance.container.setVisibility(View.GONE);
					}
	...
	private synchronized void attachOverlay(FrameLayout root) {
		...
		final FrameLayout.LayoutParams containerRightLayoutParams = new FrameLayout.LayoutParams(
				containerWidth,
				FrameLayout.LayoutParams.WRAP_CONTENT,
				Gravity.RIGHT | Gravity.BOTTOM
		);
		final FrameLayout.LayoutParams containerLeftLayoutParams = new FrameLayout.LayoutParams(
				containerWidth,
				FrameLayout.LayoutParams.WRAP_CONTENT,
				Gravity.LEFT | Gravity.BOTTOM
		);
		containerRightLayoutParams.leftMargin = 0;
		containerRightLayoutParams.rightMargin = 0;
		containerLeftLayoutParams.leftMargin = 0;
		containerLeftLayoutParams.rightMargin = 0;
		...
		for (int i = 0; i < 3; i++) {
			...
			if (i == 0) {
				...
				if (beginCalled) {
					...
					roundedImageView.setImageDrawable(new BitmapDrawable(context.getResources(), BitmapFactory.decodeByteArray(BEGIN_ICON, 0, BEGIN_ICON.length)));
					roundedImageView.setOnClickListener(new View.OnClickListener() {
						@Override
						public void onClick(View v) {
							if (!beginCalled) {
								TestFairy.begin(v.getContext(), token);
								Toast.makeText(v.getContext(), RECORD_MESSAGE, Toast.LENGTH_SHORT).show();
								beginCalled = true;
							}
				...
				roundedImageView.setImageDrawable(new BitmapDrawable(context.getResources(), BitmapFactory.decodeByteArray(FEEDBACK_ICON, 0, FEEDBACK_ICON.length)));
				roundedImageView.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View v) {
				...
				roundedImageView.setImageDrawable(new BitmapDrawable(context.getResources(), BitmapFactory.decodeByteArray(LEFT_RIGHT_ICON, 0, LEFT_RIGHT_ICON.length)));
				roundedImageView.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						if (isLeft) {
							container.setLayoutParams(containerRightLayoutParams);
						} else {
							container.setLayoutParams(containerLeftLayoutParams);
						}
	...
	static private final byte[] FEEDBACK_ICON = Base64.decode("", 0);
	static private final byte[] LEFT_RIGHT_ICON = Base64.decode("", 0);
	static private final byte[] BEGIN_ICON = Base64.decode("", 0);
	...
	static private final long RECORD_ANIMATION_FREQUENCY = 2000;
